      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="text-2xl font-bold text-gradient-orange mb-4">
              MOBIX
            </div>
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Premium food trailers designed for success. Quality craftsmanship 
              meets innovative design for the modern food entrepreneur.
            </p>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-muted-foreground">info@mobix.com</span>
              </div>
